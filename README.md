...
- [DrawMode](https://modebit.ai) - Collaborative C4/UML/ER diagramming where the AI edits the model, not the pixels; built with NiceGUI (closed-source; [desktop builds](https://github.com/ModeBit-AI/drawmode-releases)).
